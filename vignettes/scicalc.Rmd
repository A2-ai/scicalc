...
if (file.exists(file.path(data_derived, "pk_data_v01.parquet"))) {
  testthat::expect_error(scicalc::read_hashed_file(file.path(data_derived, "pk_data_v01.parquet"), "115abc8313ddaaaa6b384ab945759a63c70ff5566e8ab430f17621e35f73437d"))
}
```
...
data <- scicalc::read_hashed_file(
  ...
  algo = "blake3",
  "115abc8313ddaaaa6b384ab945759a63c70ff5566e8ab430f17621e35f73437d")
data
```
...
data <- scicalc::read_hashed_file(
  file.path(data_derived, "pk_data_v01.parquet"), 
  "419badb3414340c25066b473410539d9")
data
```
