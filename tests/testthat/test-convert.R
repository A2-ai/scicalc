test_that("convert_alb converts g/L to g/dL", {
  ...
  expect_equal(convert_alb(40), 4)
  expect_equal(convert_alb(35), 3.5)
  expect_equal(convert_alb(0), 0)

  # vectorized

  expect_equal(convert_alb(c(30, 40, 50)), c(3, 4, 5))
})
